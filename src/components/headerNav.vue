...
<div class="menu-wrapper">
  <div class="menu-block" data-theme='primary'>
    ...
    <div class='crm-menu'>
      <div class="user-info">
        <img src="http://car0.autoimg.cn/upload/2013/5/15/20130515091107062264.jpg" alt="">
        <p class='name'>张峰，欢迎你<Button type="text" size='large' icon="power" @click="$router.push({name: 'login'})"></Button></p>
      </div>
